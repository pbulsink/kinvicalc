...
New records initialize `use_count_since_cleaning` and `total_use_count`
to 0, and `last_deep_cleaned_at` to `NA`.
...
- viscometer:
  ...
  A viscometer record tibble.

## Value

The inserted viscometer record.
